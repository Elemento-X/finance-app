...
export function MonthlyEvolutionChart() {
  ...
  if (data.length === 0 || data.every((d) => d.income === 0 && d.expense === 0 && d.investment === 0)) {
    return (
      <Card>
        <CardHeader>
          <CardTitle className="text-base">{t("chart.monthlyEvolution")}</CardTitle>
        </CardHeader>
          ...
          <AreaChart data={data}>
            <defs>
              ...
              <linearGradient id="colorInvestment" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={investmentColor} stopOpacity={0.3} />
