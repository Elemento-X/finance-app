...
export const translations = {
  en: {
    ...
    'recurring.emptyDesc':
      'Set up automatic transactions for bills, salaries, etc.',
    ...
    'categories.typeDesc':
      'Mixed categories can be used for any transaction type',
    ...
    'transaction.future':
      "Future transaction (won't be included in calculations until date arrives)",
    ...
    // Portfolio
    'portfolio.noAssets':
      'No investments yet. Add your first asset to get started.',
    ...
    // Assets List
    'assets.noAssets':
      'No assets in this category yet. Add your first {{class}} asset.',
    ...
    'radar.subtitle':
      'Discover the top 10 assets in each category based on multiple metrics',
    'radar.disclaimer':
    ...
    'radar.grahamDescription':
      "Benjamin Graham's simplified formula to estimate if a stock may be undervalued.",
    ...
    'radar.grahamNegativePE':
      'P/E is negative (company has losses). Graham formula not applicable.',
    'radar.grahamInvalidPB': 'Enter a valid P/B value greater than zero.',
    'radar.grahamStatusInvest': 'Check P/B on StatusInvest',
    'radar.grahamExplanation':
      "If P/E \u00d7 P/B \u2264 22.5, the stock may be trading below its intrinsic value according to Graham's criteria. This is a simplified screening tool, not a buy recommendation.",

    // ARCA Allocation
    'arca.noInvestments':
      'No investments yet. Add assets to see your ARCA allocation.',
    'arca.strategy':
    ...
    'arca.more': 'more',
    'arca.perfectBalance':
      'Your portfolio is perfectly balanced according to the ARCA strategy!',
    ...
    'telegram.linkOpened':
      'Open Telegram and press Start to finish the connection',
    ...
    'telegram.summaryDesc':
      'Receive weekly and monthly financial summaries via Telegram',
    ...
    'budget.description': 'Get notified when spending reaches your limits',
    'budget.setLimit': 'Set Limit',
    'budget.editLimit': 'Edit Limit',
    'budget.monthlyLimit': 'Monthly Limit',
    'budget.alertAt': 'Alert at',
    'budget.ofLimit': 'of limit',
    'budget.noAlerts': 'No budget alerts configured',
    'budget.noAlertsDesc': 'Set limits on categories to control your spending',
    'budget.created': 'Budget alert created!',
    'budget.updated': 'Budget alert updated!',
    'budget.deleted': 'Budget alert removed!',
    'budget.error': 'Failed to save budget alert',
    'budget.threshold': 'Alert Threshold',
    'budget.spent': 'spent',
    'budget.remaining': 'remaining',
    'budget.exceeded': 'Exceeded!',
    'budget.alertTriggered':
      'Budget alert: {{category}} reached {{percent}}% of limit',
    'budget.alertExceeded':
      'Budget exceeded: {{category}} is over the monthly limit!',
    ...
    'backup.replaceModeDesc':
      'All current data will be replaced with the backup data',
    'backup.mergeModeDesc':
      'New items will be added without removing existing data',
    'backup.confirmRestore': 'Restore',
    'backup.tip':
      'Tip: Make regular backups to avoid losing your data. Store the backup file in a safe place like cloud storage.',

    // Dialog
    'dialog.confirmDelete': 'Confirm deletion',
    'dialog.confirmDeleteDesc':
    ...
    'validation.corruptedDataDesc':
      '{{count}} invalid item(s) were found and removed from {{type}}.',
    ...
    'validation.profileReset':
      'Your profile settings were reset due to corrupted data.',

    // Market Data Errors
    'marketData.fetchError': 'Failed to fetch market data',
    'marketData.fetchErrorDesc':
      'Could not get quotes for {{symbols}}. Using cached data if available.',
    'marketData.partialError': 'Some quotes failed',
    'marketData.partialErrorDesc':
      'Could not update {{count}} asset(s). Showing last available data.',
    'marketData.noDataAvailable': 'No market data',
    'marketData.noDataAvailableDesc':
      'Quote not available for {{symbol}}. Check if the ticker is correct.',
    'marketData.usingCachedData': 'Using cached data',
    'marketData.cacheExpired': 'Market data may be outdated',
    'marketData.fixedIncomeNoQuote':
      "Fixed income assets don't have real-time quotes",

    // Investment Alerts
    'alerts.arcaBelow': '{{category}} is below ARCA target by {{percent}}%',
    'alerts.arcaAbove': '{{category}} is above ARCA target by {{percent}}%',
    'alerts.highVolatility':
      '{{symbol}} has high volatility: {{change}}% today',
    'alerts.concentration':
      '{{symbol}} represents {{percent}}% of your portfolio',
    ...
    'migration.description':
      'Upload your local data to the cloud for sync across devices',
    ...
    'migration.errorDesc':
      'Could not upload data. Check your connection and try again.',
    'migration.noData': 'No local data to upload',
    'migration.results': 'Results',
    'migration.migrated': 'uploaded',
    'migration.failed': 'failed',
    'migration.note':
      'This is a one-time upload. After this, all changes sync automatically.',
  ...
  pt: {
    ...
    'recurring.emptyDesc':
      'Configure transações automáticas para contas, salários, etc.',
    ...
    'categories.typeDesc':
      'Categorias mistas podem ser usadas para qualquer tipo de transação',
    ...
    'transaction.future':
      'Lançamento futuro (não será incluído nos cálculos até a data chegar)',
    ...
    // Portfolio
    'portfolio.noAssets':
      'Nenhum investimento ainda. Adicione seu primeiro ativo para começar.',
    ...
    // Assets List
    'assets.noAssets':
      'Nenhum ativo nesta categoria ainda. Adicione seu primeiro ativo de {{class}}.',
    ...
    'radar.subtitle':
      'Descubra os 10 melhores ativos em cada categoria com base em múltiplas métricas',
    'radar.disclaimer':
    ...
    'radar.grahamDescription':
      'F\u00f3rmula simplificada de Benjamin Graham para estimar se uma a\u00e7\u00e3o pode estar subvalorizada.',
    ...
    'radar.grahamUndervalued':
      'A\u00e7\u00e3o pode estar subvalorizada (\u2264 22,5)',
    'radar.grahamOvervalued':
      'A\u00e7\u00e3o pode estar sobrevalorizada (> 22,5)',
    'radar.grahamNegativePE':
      'P/L negativo (empresa com preju\u00edzo). F\u00f3rmula de Graham n\u00e3o se aplica.',
    'radar.grahamInvalidPB':
      'Digite um valor de P/VP v\u00e1lido maior que zero.',
    'radar.grahamStatusInvest': 'Consultar P/VP no StatusInvest',
    'radar.grahamExplanation':
      'Se P/L \u00d7 P/VP \u2264 22,5, a a\u00e7\u00e3o pode estar sendo negociada abaixo do seu valor intr\u00ednseco segundo os crit\u00e9rios de Graham. Esta \u00e9 uma ferramenta de triagem simplificada, n\u00e3o uma recomenda\u00e7\u00e3o de compra.',

    // ARCA Allocation
    'arca.noInvestments':
      'Nenhum investimento ainda. Adicione ativos para ver sua alocação ARCA.',
    'arca.strategy':
      'Estratégia ARCA por Thiago Nigro: 25% Renda Fixa, 25% Renda Variável, 25% ETFs, 25% Criptomoedas',
    ...
    'arca.more': 'a mais',
    'arca.perfectBalance':
      'Seu portfólio está perfeitamente balanceado de acordo com a estratégia ARCA!',
    ...
    'profile.telegramDesc':
      'Conecte o Telegram para registrar transações pelo chat',
    ...
    'telegram.linkOpened':
      'Abra o Telegram e clique em Start para finalizar a conexão',
    ...
    'telegram.summaryDesc':
      'Receba resumos financeiros semanais e mensais pelo Telegram',
    ...
    // Budget Alerts
    'budget.title': 'Alertas de Orçamento',
    'budget.description':
      'Receba notificações quando os gastos atingirem seus limites',
    'budget.setLimit': 'Definir Limite',
    'budget.editLimit': 'Editar Limite',
    'budget.monthlyLimit': 'Limite Mensal',
    'budget.alertAt': 'Alertar em',
    'budget.ofLimit': 'do limite',
    'budget.noAlerts': 'Nenhum alerta de orçamento configurado',
    'budget.noAlertsDesc':
      'Defina limites nas categorias para controlar seus gastos',
    'budget.created': 'Alerta de orçamento criado!',
    'budget.updated': 'Alerta de orçamento atualizado!',
    'budget.deleted': 'Alerta de orçamento removido!',
    'budget.error': 'Falha ao salvar alerta de orçamento',
    'budget.threshold': 'Limite de Alerta',
    'budget.spent': 'gasto',
    'budget.remaining': 'restante',
    'budget.exceeded': 'Excedido!',
    'budget.alertTriggered':
      'Alerta de orçamento: {{category}} atingiu {{percent}}% do limite',
    'budget.alertExceeded':
      'Orçamento excedido: {{category}} ultrapassou o limite mensal!',

    // Backup
    'backup.title': 'Backup e Restauração',
    'backup.description':
      'Exporte seus dados ou restaure a partir de um arquivo de backup',
    ...
    'backup.mergeModeDesc':
      'Novos itens serão adicionados sem remover os dados existentes',
    'backup.confirmRestore': 'Restaurar',
    'backup.tip':
      'Dica: Faça backups regularmente para evitar perder seus dados. Guarde o arquivo de backup em um local seguro como armazenamento em nuvem.',
    ...
    'validation.corruptedDataDesc':
      '{{count}} item(ns) inválido(s) foram encontrados e removidos de {{type}}.',
    ...
    'validation.profileReset':
      'Suas configurações de perfil foram redefinidas devido a dados corrompidos.',

    // Market Data Errors
    'marketData.fetchError': 'Falha ao buscar dados de mercado',
    'marketData.fetchErrorDesc':
      'Não foi possível obter cotações para {{symbols}}. Usando dados em cache se disponíveis.',
    'marketData.partialError': 'Algumas cotações falharam',
    'marketData.partialErrorDesc':
      'Não foi possível atualizar {{count}} ativo(s). Mostrando últimos dados disponíveis.',
    'marketData.noDataAvailable': 'Sem dados de mercado',
    'marketData.noDataAvailableDesc':
      'Cotação não disponível para {{symbol}}. Verifique se o ticker está correto.',
    'marketData.usingCachedData': 'Usando dados em cache',
    'marketData.cacheExpired': 'Dados de mercado podem estar desatualizados',
    'marketData.fixedIncomeNoQuote':
      'Ativos de renda fixa não possuem cotação em tempo real',
    ...
    'alerts.highVolatility':
      '{{symbol}} tem alta volatilidade: {{change}}% hoje',
    'alerts.concentration':
      '{{symbol}} representa {{percent}}% do seu portfólio',
    ...
    'migration.description':
      'Envie seus dados locais para a nuvem para sincronizar entre dispositivos',
    ...
    'migration.note':
      'Este é um envio único. Após isso, todas as alterações sincronizam automaticamente.',
