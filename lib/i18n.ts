...
export const translations = {
  en: {
    ...
    "budget.alertTriggered": "Budget alert: {{category}} reached {{percent}}% of limit",
    "budget.alertExceeded": "Budget exceeded: {{category}} is over the monthly limit!",
  ...
  pt: {
    ...
    "budget.description": "Receba notificações quando os gastos atingirem seus limites",
    ...
    "budget.noAlertsDesc": "Defina limites nas categorias para controlar seus gastos",
    ...
    "budget.alertTriggered": "Alerta de orçamento: {{category}} atingiu {{percent}}% do limite",
    "budget.alertExceeded": "Orçamento excedido: {{category}} ultrapassou o limite mensal!",
